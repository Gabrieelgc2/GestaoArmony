...
export function FormularioRelatorioMedicao({ onSalvar }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.calhas || !form.soleira_porta_giro || !form.acabamento || !form.trilho_especial) {
          ...
          {GUIA_CONFIG.calhas.map((item) => {
            ...
            return (
              <button
                ...
                className={`p-2.5 rounded-xl border flex flex-col items-center gap-2 transition text-left cursor-pointer ${ativo ? "border-blue-600 bg-blue-50/50 ring-2 ring-blue-500/20" : "border-gray-200 hover:border-gray-300"
                  }`}
              >
          ...
          {GUIA_CONFIG.acabamentos.map((item) => {
            ...
            return (
              <button
                ...
                className={`p-2.5 rounded-xl border flex flex-col items-center gap-2 transition text-left cursor-pointer ${ativo
